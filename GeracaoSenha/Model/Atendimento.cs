...
namespace GeracaoSenha.Model
{
    public class Atendimento
    {
        ...
        {
            return ((Atendimento)obj).Id == Id &&
                ((Atendimento)obj).TipoAtendimento == TipoAtendimento &&
                ((Atendimento)obj).HorarioChegada == HorarioChegada;
        }

        public string Senha()
        {
            string sigla = SiglaTipoAtendimento.GetSiglaTipoAtendimento(TipoAtendimento);
            return sigla + Id.ToString().PadLeft(4, '0');
        }
